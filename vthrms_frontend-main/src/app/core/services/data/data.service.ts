...
export class DataService {
  ...
  /*public getEmployees(): Observable<apiResultFormat> {
    ...
    public getAllVacancy(): Observable<apiResultFormat> {
      console.log('Calling getAllVacancies from frontend');
      return this.http.get<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/getAllVacancy`).pipe(
        map((res: apiResultFormat) => {
          return res;
        })
      );
    ...
    public getSiteVacancy(): Observable<apiResultFormat> {
      console.log('Calling getSiteVacancies from frontend');  

      return this.http.get<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/getSiteVacancy`).pipe(
        map((res: apiResultFormat) => res)
      );
    }


    public getVacancy(id: number): Observable<apiResultFormat> {
      console.log('Calling getVacancy from frontend');

      return this.http.get<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/getVacancy/${id}`).pipe(
        map((res: apiResultFormat) => res)
      );
    }
    ...
    //add
    public AddVacancy(data: any): Observable<apiResultFormat> {
      console.log('Calling addVacancy from frontend');

      return this.http.post<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/AddVacancy`, data).pipe(
        map((res: apiResultFormat) => res)
      );
    }    


    public AddApplicationVacancy(data: any): Observable<apiResultFormat> {
      console.log('Calling AddApplicationVacancy from frontend');

      return this.http.post<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/AddApplicationVacancy`, data).pipe(
        map((res: apiResultFormat) => res)
      );
    }

    public UpdateVacancy(data: any): Observable<apiResultFormat> {
      console.log('Calling updateVacancy from frontend');

      return this.http.post<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/UpdateVacancy`, data).pipe(
        map((res: apiResultFormat) => res)
      );
    }


    public UpdateVacancystatus(data: any): Observable<apiResultFormat> {
      console.log('Calling updateVacancyStatus from frontend');

      return this.http.post<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/UpdateVacancystatus`, data).pipe(
        map((res: apiResultFormat) => res)
      );
    }
  
    public UpdateVacancyApplication(data: any): Observable<apiResultFormat> {
      console.log('Calling updateVacancyApplication from frontend');

      return this.http.post<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/UpdateVacancyApplication`, data).pipe(
        map((res: apiResultFormat) => res)
      );
    }

    public deleteVacancy(id: number): Observable<apiResultFormat> {
      console.log('Calling deleteVacancy from frontend');

      return this.http.post<apiResultFormat>(`${environment.apiUrl}/hcm/talant-management/deleteVacancy`, { id }).pipe(
        map((res: apiResultFormat) => res)
      );
    }
   ...
   //employee management
  public getEmployees(): Observable<apiResultFormat> {
    console.log("get employee backend from frontend")

    return this.http.get<apiResultFormat>(
      `${environment.apiUrl}/hcm/employee-managment/getEmployees`).pipe(
      map((res: apiResultFormat) => {
        return res;
      })
    );
  }
  public addemployee(data:any): Observable<apiResultFormat> {
    return this.http.post<any>(`${environment.apiUrl}/hcm/employee-managment/addEmployee/`, data);
  }

  public getRoles(): Observable<apiResultFormat> {
    return this.http.get<apiResultFormat>(
      `${environment.apiUrl}/authz/roles`).pipe(
      map((res: apiResultFormat) => {
        return res;
      })
    );
  ...
  public getDesignations(): Observable<apiResultFormat> {
    return this.http.get<apiResultFormat>(`${environment.apiUrl}/authz/designation`).pipe(
      map((res: apiResultFormat) => {
        return res;
      })
    );
  ...
  public getholidays(): Observable<apiResultFormat> {
    return this.http.get<apiResultFormat>
    (`${environment.apiUrl}/hcm/workforce/leave/getAllHoliday`).pipe(
      map((res: apiResultFormat) => {
        console.log(res)
        return res;
      })
  ...
  public addHolidays(data:any): Observable<apiResultFormat> {
    return this.http.post<any>(`${environment.apiUrl}/hcm/workforce/leave/addHoliday/`, data);
  }

  public getemployee(id: number): Observable<apiResultFormat> {
    return this.http.get<any>(`${environment.apiUrl}/hcm/employee-managment/getEmployee/${id}`);
  }
