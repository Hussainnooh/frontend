...
export class ManageJobsComponent implements OnInit {
  ...
  private getTableData(): void {
    console.log('just table from backend')

    this.allManageJobs = [];
    this.serialNumberArray = [];

    this.data.getAllVacancy().subscribe((res: any) => {
      console.log(res)
  ...
  public addJob(): void {
    if (this.addManageJobs.valid) {
      this.data.AddVacancy(this.addManageJobs.value).subscribe((res) => {
  ...
  public updateJob(jobId: number): void {
    if (this.editManageJobs.valid) {
      this.data.UpdateVacancy({ id: jobId, ...this.editManageJobs.value }).subscribe((res) => {
  ...
  public deleteJob(jobId: number): void {
    this.data.deleteVacancy(jobId).subscribe((res) => {
